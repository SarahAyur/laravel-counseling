                        ...
                        @foreach($sessions as $session)
                            <div class="bg-white rounded-lg shadow mb-4 overflow-hidden">
                                ...
                                <div class="bg-gray-50 p-3 flex flex-wrap gap-2">
                                    <a href="{{ route('konseling-konselor.show', $session) }}" class="inline-block">
                                    ...
                                    @if($session->status === 'pending')
                                        <form action="{{ route('konseling-konselor.status', $session) }}" method="POST"
                                              class="inline-block">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <a href="{{ route('reschedule.create', $session) }}"
                                           class="inline-flex items-center px-3 py-1.5 bg-amber-100 hover:bg-amber-200 text-amber-700 text-sm font-medium rounded-md transition duration-150 ease-in-out">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                                 viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                      stroke-width="2"
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            @foreach($sessions as $session)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm">
                                        <x-dropdown-action>
                                            <a href="{{ route('konseling-konselor.show', $session) }}"
                                            ...
                                            @if($session->status === 'pending')
                                                <form
                                                    action="{{ route('konseling-konselor.status', $session) }}"
                                                ...
                                                <a href="{{ route('reschedule.create', $session) }}"
                                                   class="inline-flex w-full items-center px-3 py-2 bg-amber-100 hover:bg-amber-200 text-amber-700 text-sm font-medium rounded-md transition duration-150 ease-in-out">
