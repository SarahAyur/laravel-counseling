                        ...
                        <div class="p-4">
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $konseling->mahasiswa->nim ?? '-' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Email</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $konseling->mahasiswa->email ?? '-' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">WhatsApp</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $konseling->mahasiswa->whatsapp_number ?? '-' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Program Studi</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $konseling->mahasiswa->prodi ?? '-' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Semester</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $konseling->mahasiswa->semester ?? '-' }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Tipe Mahasiswa</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $konseling->mahasiswa->student_type ?? '-' }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
